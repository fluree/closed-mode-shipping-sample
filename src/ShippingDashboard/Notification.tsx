...
import { X, CircleCheckBig, ShieldAlert } from 'lucide-react'
...
export default function Notification({show, handleClose, success, title, detail}: NotificationProps) {
              ...
              <div className="p-4">
                <div className="flex items-start">
                  <div className="shrink-0">
                    {success ? (
                        <CircleCheckBig aria-hidden="true" className="size-6 text-green-400" />
                    ) : (
                        <ShieldAlert aria-hidden="true" className="size-6 text-red-400" />
                    )}
                  </div>
